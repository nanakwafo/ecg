        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li class="scroll-to-section"><a href="/home" class="menu-item">Home</a></li>
                        <li class="scroll-to-section"><a href="/home" class="menu-item">About</a></li>
        ...
        <div class="footer-content">
            <div class="row">
                ...
                <div class="right-content col-lg-6 col-md-12 col-sm-12">
                    <h2><em>Register</em> to make a purchase</h2>
